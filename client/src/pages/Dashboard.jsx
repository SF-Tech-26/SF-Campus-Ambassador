      ...
      <div className="relative min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 py-20 md:py-24 px-4 sm:px-6 md:px-8">
          ...
          <div className="text-center mb-10 md:mb-14">
            <h2 className="font-jaro text-2xl sm:text-7xl font-bold text-white" style={{ letterSpacing: '0.15em' }}>
              DASHBOARD
            </h2>
            <p className="text-gray-300 text-sm sm:text-base opacity-80">
              Campus Ambassador
            </p>
          </div>

          {/* Spell Cards Grid: Uses mock GlassCard */}
          <div className="flex flex-row lg:grid-cols-4 gap-6 md:gap-8 mb-10 md:mb-14">
