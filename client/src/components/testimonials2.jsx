...
function Testimonials(){
    ...
    return(
        <>
        <div className="bg-gradient-to-br from-purple-950 via-purple-900 to-indigo-950 flex flex-col h-full w-full justify-center items-center py-16 px-4">
            <h1 className="text-5xl md:text-6xl text-white underline font-serif text-center font-bold mb-16">Testimonials</h1>
